...
SECRET_KEY = 'django-insecure-lfcy#d&=!fq=$gb8wizf^opqnb#f9vwiy84ek#b#)38opw4o76'
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=7),  # puedes ajustarlo también
}
